---
title: "disaster-recovery-plan skill: RTO/RPO, backup strategy, and failover runsheets"
sidebarTitle: "Disaster Recovery"
description: "Produce a disaster recovery plan defining RTO/RPO targets, 3-2-1 backup strategy, per-scenario failover runsheets, and a drill schedule — covering regional outages, ransomware, and data corruption."
---
