---
title: "user-personas-behavior skill: personas, JTBD, and success metrics"
sidebarTitle: "User Personas"
description: "Define who a product is for using Jobs-to-Be-Done framing, map user journeys, set leading and lagging success metrics, and produce a concrete analytics event-tracking plan."
---
...
## The 5-Phase Generation Process
...
- [ ] At least one persona includes an accessibility dimension
- [ ] Negative personas are defined to prevent scope creep
