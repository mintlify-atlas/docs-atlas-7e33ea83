---
title: "technical-runbook skill: on-call operations manual following Google SRE"
sidebarTitle: "Runbook"
description: "Generate a production runbook that equips any on-call engineer with alert procedures, diagnostic commands, escalation paths, and maintenance steps following Google SRE standards."
---
