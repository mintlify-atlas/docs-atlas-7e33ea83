---
title: "API Design Document Skill: OpenAPI 3.1 and RFC 7807"
sidebarTitle: "API Design"
description: "Design a production REST API: resource model, endpoint contracts, OpenAPI 3.1, RFC 7807 errors, versioning, rate limiting, pagination, and webhooks."
---
