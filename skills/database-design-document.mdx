---
title: "Database Design Document Skill: ERD and Schema"
sidebarTitle: "Database Design"
description: "Design a production database schema: Mermaid ERD, MySQL/PostgreSQL DDL, data dictionary, indexing strategy, normalization, and migration rollbacks."
---
