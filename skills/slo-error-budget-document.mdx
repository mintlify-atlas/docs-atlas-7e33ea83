---
title: "SLO & Error Budget Document — SLI targets and burn-rate"
sidebarTitle: "SLO & Error Budget"
description: "Define SLI/SLO targets, error budgets, and multi-window burn-rate alerts with a pre-agreed budget policy that replaces reliability debates with data."
---
