...
description: "Install all 22 engineering skills in Gemini CLI using the official extensions command, the --gemini flag, a manual git clone, or the cross-platform setup script."
---
