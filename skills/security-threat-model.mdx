---
title: "security-threat-model skill: STRIDE analysis, attack surface, and mitigations"
sidebarTitle: "Threat Model"
description: "Invoke the security-threat-model skill to produce a structured STRIDE threat model, DFD trust boundaries, risk register, and concrete mitigations before code ships."
---
...
<Info>
  **Type:** Workflow &nbsp;·&nbsp; **Estimated time:** 4–8 hours &nbsp;·&nbsp; **Standards:** Microsoft STRIDE, OWASP Top 10, CVSS risk scoring &nbsp;·&nbsp; **Output file:** `12-security-threat-model.md` &nbsp;·&nbsp; **Inclusion:** Conditional — include when the system handles authentication, payments, PII, or any external attack surface
</Info>
...
| `15-implementation-plan.md` | Security controls to sequence into build phases |
