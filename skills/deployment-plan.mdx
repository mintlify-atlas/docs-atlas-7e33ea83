---
title: "deployment-plan skill: release strategy, go/no-go gate, and rollback procedure"
sidebarTitle: "Deployment Plan"
description: "Invoke the deployment-plan skill to produce a production deployment runsheet covering release strategy, go/no-go checklist, monitoring plan, rollback steps, and sign-off."
---
...
<Info>
  **Type:** Workflow &nbsp;·&nbsp; **Estimated time:** 2–4 hours &nbsp;·&nbsp; **Standards:** DORA metrics, ITIL change management, blue-green/canary deployment patterns &nbsp;·&nbsp; **Output file:** `16-deployment-plan.md` &nbsp;·&nbsp; **Inclusion:** Always-core — every non-trivial production release
</Info>
