---
title: "using-engineering-docs: the Engineering Docs orchestrator skill"
sidebarTitle: "Orchestrator"
description: "The entry-point skill that takes a raw project idea, decides which of the 22 skills apply, and drives the full documentation pipeline end to end without you naming a single skill."
---
