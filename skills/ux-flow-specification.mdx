---
title: "UX Flow Specification Skill: Screen Flows and States"
sidebarTitle: "UX Flow"
description: "Map every screen state (loading, empty, error, success), user journeys, information architecture, and edge case recovery paths before implementation."
---
