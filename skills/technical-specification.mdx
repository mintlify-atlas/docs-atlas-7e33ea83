---
title: "technical-specification skill: ISO/IEC/IEEE 29148 requirements with EARS syntax"
sidebarTitle: "Tech Specification"
description: "Generate a complete SRS/TSD with SMART requirements in EARS syntax, FR/NFR coverage, traceability matrix, and acceptance criteria aligned to ISO/IEC/IEEE 29148."
---
...
<Info>
  **At a glance**
  ...
  | **Output file** | `4-technical-specification.md` |
