...
description: "Add 22 engineering documentation skills to Cursor or Windsurf as project-scoped .mdc rules — one rule file per skill, installed to .cursor/rules/ in seconds."
---
...
```json integrations/plugins/.cursor-plugin/plugin.json
{
  ...
  "description": "22 engineering documentation skills covering the complete software lifecycle.",
  "version": "1.2.1",
  "author": {
    "name": "Fattain Naime",
