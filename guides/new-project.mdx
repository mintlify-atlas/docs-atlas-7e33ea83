---
title: "Start a new project with Engineering Docs Greenfield Mode"
sidebarTitle: "New Project"
description: "Walk through Greenfield Mode end to end: from a raw idea to a complete .engineering-docs/ folder ready for any coding agent to build from."
---
