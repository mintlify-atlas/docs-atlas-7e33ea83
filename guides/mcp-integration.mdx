---
title: "Use Engineering Docs MCP server for document validation"
sidebarTitle: "MCP Integration"
description: "How the Engineering Docs MCP server exposes validate_document_set, check_consistency, and generate_index to MCP-compatible clients and CI pipelines."
---
