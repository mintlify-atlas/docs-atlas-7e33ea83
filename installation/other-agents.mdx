...
description: "Flag-by-flag install guide for Goose, Pi, OpenCode, Kilo Code, Roo Code, Cline, Factory Droid, Kimi Code, Codex, and Copilot CLI — all 22 skills, every platform."
---
