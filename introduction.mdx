...
description: "Engineering Docs is an open-source npm plugin giving AI coding agents 22 composable documentation skills — from raw idea to production-ready blueprint."
---
